...
class LayerManager {
    ...
    private generateSymbolLayerConfig(layerName: string, source: string, iconName: string, defaultColor: string, forceProperty: string | null = null, hasIcon = true): LayerSpecification {
        return {
            id: layerName,
            type: 'symbol',
            source: source,
