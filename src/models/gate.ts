...
export const gateCodesData: { [key: string]: any } = {
  ...
  B: {
    ...
    maxWingSpan: 24,
    aircraftTypes:
      "AC95,AN28,AN38,ASTR,AT43,AT44,AT45,AT46,B190,B350,BE20,BE70,BE80,C212,C56X,C650,C680,C700,C750,CL30,CL35,CL60,CRJ1,CRJ2,CRJ5,CRJ7,D228,D328,DHC6,E120,E135,E145,E2,E55P,F2TH,F900,FA20,FA50,G150,G280,GALX,GLF3,GLF4,H25B,J328,JS41,L10,L29B,L410,N262,PC12,SB20,SF34,SH33,SH36,SW4,YK40",
  },
  C: {
    code: "C",
    minWingSpan: 24,
  ...
  D: {
    ...
    maxWingSpan: 52,
    aircraftTypes:
      "A306,A30B,A310,A3ST,A400,AN12,AN70,B701,B703,B720,B752,B753,B762,B763,B764,C130,C135,C141,C160,C17,C30J,CONI,DC10,DC7,DC85,DC86,DC87,E3CF,E3TF,IL18,IL62,IL76,IL86,K35E,K35R,L101,MD11,R135,T154,T204,VC10",
  },
  E: {
    code: "E",
    minWingSpan: 52,
    maxWingSpan: 65,
    aircraftTypes:
      "A332,A333,A338,A339,A342,A343,A345,A346,A359,A35K,AN22,B741,B742,B743,B744,B74D,B74R,B74S,B772,B773,B778,B779,B77L,B77W,B788,B789,B78X,CONC,IL96",
  },
  F: {
    code: "F",
    minWingSpan: 65,
